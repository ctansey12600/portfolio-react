  ...
  return (
    <div className="blog-card">
      ...
      <div className="blog-card-info">
        <h3>{data.name}</h3>
        <hr />
        <div className="blog-card-info-section">
          <p>
            Published: {data.date}
            <br />
